...
The first step is to access my gmail inbox. You can find my gmail password, address, etc. in the ENV vars.
...
Once succesful or if you need help, let me know. Try to send me some content from my latest gmail or something like that.
    """
    )
