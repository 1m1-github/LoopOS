...
write(joinpath(".inbox", "mission.txt"), """
...
# sttport = openport()
sttport = 8888
sttserver(port=sttport, sttpypath=abspath("stt.py"))

include("browser.jl")
# include("src/browser.jl")
# browserport = openport()
browserport = sttport+1
browserserver(path=pwd(), port=browserport)
